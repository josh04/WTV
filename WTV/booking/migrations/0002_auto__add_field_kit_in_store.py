...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Kit.in_store'
        db.add_column('booking_kit', 'in_store', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Kit.in_store'
        db.delete_column('booking_kit', 'in_store')
    ...
    models = {
        ...
        'booking.kit': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_store': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
