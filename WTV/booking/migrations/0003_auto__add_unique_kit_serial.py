...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Kit', fields ['serial']
        db.create_unique('booking_kit', ['serial'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Kit', fields ['serial']
        db.delete_unique('booking_kit', ['serial'])
